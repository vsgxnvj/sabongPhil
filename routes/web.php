   ...
   Route::GET('/auth/google/call-back', [GoogleAuthController::class, 'callbackGoogle']);
    ...
    Route::group(['middleware' => CheckUserRole::class . ':1'], function () {
        ...
        */
            ...
            Route::GET('/cashout-notification', [notifController::class, 'cashoutnotif']);



            // 
             Route::GET('/activate', [siteController::class, 'activate']);
             Route::POST('/activate/{id}', [siteController::class, 'updateactivate']);
    ...
    */
    ...
    Route::GET('/list-games-register/{id}', [listgameController::class, 'create']);
